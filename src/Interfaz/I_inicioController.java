...
public class I_inicioController {
	...
	@FXML
	private Button btnLimpiarFormularioCliente;
	@FXML
	...
	@FXML
	private Button btnLimpiarFormularioAuto;
	@FXML
	...
	@FXML
	void btnEliminarCLiente() {
		System.out.println("Anny intentando eliminando un cliente <3");
		L_clientes.eliminarCliente(txtIdCliente);
		llenarTablaClientes();
	}

	// Event Listener on Button[#btnLimpiarFormulario].onAction
	@FXML
	public void btnLimpiarFormularioCliente(ActionEvent event) {
		// TODO Autogenerated
